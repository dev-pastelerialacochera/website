	...
	<main class="main" id="main">
		...
		<section class="main-section container full">
			<center>
				...
				<a class="active" href="/colima" data-index="5">Colima | </a>
		...
		<section class="container full">
			<div class="Inicio__grid">
				...
				<div class="Inicio__text">
					<h2 class="section-title">Café Colima</h2>
						<p>Gracias al terruño volcánico, el nivel de acidez es moderada y los aromas son muy perceptible a nueces y chocolate con toque dulce y terroso, cuerpo ligero medio, es un café de proceso natural.</p>
						<p>Tipo de tueste: Claro Medio.<br><img src=/imagenes/tuestemedio.png></p>
				</div>
			</div>
		</section>
