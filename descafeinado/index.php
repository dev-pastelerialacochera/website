	...
	<main class="main" id="main">
		...
		<section class="main-section container full">
			<center>
				...
				<a class="active" href="/descafeinado" data-index="7">Descafeinado | </a>
		...
		<section class="container full">
			<div class="Inicio__grid">
				...
				<div class="Inicio__text">
					<h2 class="section-title">Café Descafeinado</h2>
						<p>Café de Veracruz. A pesar de no contener cafeína, podrá disfrutar de una buena taza de café a cualquier hora del día, es ligero, pero tiene cuerpo y notas a caramelo. El retrogusto es corto y amable.</p>
